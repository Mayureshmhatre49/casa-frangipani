...
@unless($showThanks)
<form id="bookingForm" action="{{ route('booking.enquire') }}" method="POST" wire:submit.prevent="submit" class="space-y-4 bg-black/40 p-6 rounded-2xl shadow-lg">
    @csrf
...
<div class="space-y-4 bg-black/40 p-8 rounded-2xl shadow-lg text-center">
